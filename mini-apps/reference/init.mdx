---
title: "Init"
description: "Upon opening a mini app, World App will set a window.WorldApp object. This object contains useful metadata about the device, user, and commands that can be used to customize the mini app." 
---

```yaml src/app/page.tsx
{
