---
title: "Verify"
description: "The verify command lets you use [incognito actions](https://docs.world.org/world-id/id/cloud) inside of your mini app. Incognito actions are a primitive of World ID and allow you to gate functionality behind a unique human check."
---
...
```yaml src/app/page.tsx expandable
...
```yaml src/app/api/verify.ts expandable
...
<iframe
  width="560"
  height="315"
  src="https://docs.world.org/images/docs/mini-apps/commands/verify-command.mp4"
