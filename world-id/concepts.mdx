---
title: "Core Concepts"
description: "World ID is built for easy integration, but here are a few core concepts that are helpful to understand before you start."
...
| --- | --- | --- |
| ![](https://docs.world.org/icons/credential-face.svg)Orb+ | Very Strong | \[Coming soon\] Orb verification, plus authentication which verifies the person using World ID is the legitimate holder. |
| ![](https://docs.world.org/icons/credential-orb.svg)Orb | Strong | Biometric verification, uniqueness through iris ([details](https://world.org/blog/engineering/opening-orb-look-inside-worldcoin-biometric-imaging-device)). |
| ![](https://docs.world.org/icons/credential-passport-nfc.svg)Secure Document | High | Document verification eg. Passport with security chip verification |
| ![](https://docs.world.org/icons/credential-passport.svg)Document | High | Document verification eg. Passport |
| ![](https://docs.world.org/icons/credential-phone.svg)Device | Medium | Unique mobile device check. |
