...
- But the user **still has the original device** (or the original Root Key in some other form), and therefore can reproduce the deterministic backup-account `secp256k1` keypair and produce a signature on it.
