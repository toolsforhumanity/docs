...
Importantly, this process wipes the entire state of the `backup-service` for the user as well as their Turnkey account. Please note that support for deleting the stale Turnkey account was introduced around August 2026, previously set up accounts cannot be deleted by the user as the user is unable to authenticate.
